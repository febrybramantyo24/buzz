                          ...
                          {categories
                            ...
                            .map(cat => (
                              <button
                                ...
                                className={`w-full text-left px-4 py-2.5 text-xs hover:bg-indigo-600/10 hover:text-indigo-500 dark:text-indigo-400 transition-colors ${
                          ...
                          {services
                            ...
                            .map(service => (
                              <button
                                ...
                                className={`w-full text-left px-4 py-2.5 text-xs hover:bg-indigo-600/10 hover:text-indigo-500 dark:text-indigo-400 transition-colors flex flex-col gap-0.5 ${
