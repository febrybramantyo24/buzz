  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-indigo-500 selection:text-white overflow-x-hidden relative">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10">
        ...
        {/* Title */}
        <div className="mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-indigo-150 dark:border-indigo-500/30 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-950 dark:text-indigo-300 text-xs font-black mb-4">
            <BookOpen className="w-3.5 h-3.5 text-indigo-800 dark:text-indigo-400" />
        ...
        {/* Card */}
        <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800 p-8 sm:p-10 rounded-3xl shadow-xl text-slate-350 text-sm font-light leading-relaxed">
          {settings.terms_content ? (
            <div 
              className="prose prose-invert max-w-none space-y-6 whitespace-pre-wrap"
              dangerouslySetInnerHTML={{ __html: settings.terms_content }}
            />
          ) : (
            <div className="space-y-8 text-slate-300">
              <p>
                Selamat datang di <strong>{brandName}</strong>. Dengan mendaftar, mengakses, atau menggunakan layanan kami, Anda menyatakan telah membaca, memahami, dan menyetujui semua aturan, syarat, dan ketentuan yang berlaku di bawah ini. Jika Anda tidak menyetujui bagian apa pun dari ketentuan ini, Anda tidak diperkenankan menggunakan layanan kami.
              </p>
              ...
              <div className="space-y-3">
                ...
                <p className="pl-9">
                  {brandName} adalah platform penyedia optimasi media sosial (buzzer) yang membantu meningkatkan interaksi akun Anda (followers, likes, views, subscriber, dan sejenisnya). Layanan kami semata-mata digunakan untuk tujuan promosi dan pengembangan visual media sosial Anda secara sah.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc list-outside pl-13 space-y-2">
                  ...
                  <li>
                    <strong>Ketentuan Non-Refundable:</strong> Saldo akun yang sudah di-top-up <strong>tidak dapat diuangkan kembali</strong> atau ditransfer ke rekening pribadi/bank pihak ketiga. Saldo hanya dapat digunakan untuk pembelian layanan di dalam platform {brandName}.
                  </li>
                  <li>Jika terjadi kegagalan pemesanan sistem (misalnya sistem error atau server overload), dana pembelian pesanan tersebut akan dikembalikan secara otomatis 100% ke <strong>Saldo Akun {brandName}</strong> Anda, bukan ke rekening asal Anda.</li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc list-outside pl-13 space-y-2">
                  <li>{brandName} tidak bertanggung jawab atas tindakan penghapusan postingan, pemblokiran akun, atau suspend yang dilakukan oleh platform media sosial (seperti Instagram, TikTok, YouTube) terhadap akun Anda.</li>
